...
namespace ConsoleUtils
{
    public static class ConsoleExt
    {
        ...
        private static void UpdateBufferWidthLin()
        {
            //int AA = Console.CursorTop;
            //Console = (Math.Max(Console.BufferWidth, Math.Min(byte.MaxValue, Math.Max(_maxLineLength, CurrentLine.Length + 1)));
        }
